...
function colocarPines(data) {
    let lat, lng, nombre, infoWindowActivo;

    // patron es lo que hay que modificar
    // let patron = "Centro integrado";
    // let patron = "Centro de estudios";
    //let patron = "Centro de enseñanza";
    //let patron = "Centro privado de Educación de Adultos";
    //let patron = "Centro Privado de Formación Profesional";
    //let patron = "Centro de Formación Profesional";
    // let patron = "Escuela Infantil Pública";
    let patron = "Instituto de Educación Secundaria";
    //let patron = "Centro privado de Educación de Adultos";
    // let patron = "Centro de Educación de Personas Adultas (CEPA)";
    // let patron = "Escuela Infantil";
    // let patron = "Centro de Educación Especial";
    ...
    data.forEach(element => {
        ...
        if (element.location !== undefined && element.title.substring(0, patron.length).toUpperCase() == patron.toUpperCase()) {
            console.log(element.title);
